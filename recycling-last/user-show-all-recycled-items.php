...
<head>
    ...
    <link rel="stylesheet" href="recycled-items.css">
</head>
<body>
    ...
    $sql = "SELECT * FROM recycled_items";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<table>";
        echo "<tr><th>ID</th><th>Image</th><th>Weight</th><th>Height</th><th>Material Type</th><th>Uploader's Name</th></tr>";
        while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>";
            echo "<td>{$row['recycled_id']}</td>";
